...
import { sampleWithRequiredData } from '../employment.test-samples';
...
describe('Employment Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.employments()[0]).toEqual(expect.objectContaining({ id: 30829 }));
  });

  describe('trackId', () => {
    it('should forward to employmentService', () => {
      const entity = { id: 30829 };
      jest.spyOn(service, 'getEmploymentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEmploymentIdentifier).toHaveBeenCalledWith(entity);
