...
import { sampleWithRequiredData } from '../account-type.test-samples';
...
describe('AccountType Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.accountTypes()[0]).toEqual(expect.objectContaining({ id: 7043 }));
  });

  describe('trackId', () => {
    it('should forward to accountTypeService', () => {
      const entity = { id: 7043 };
      jest.spyOn(service, 'getAccountTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAccountTypeIdentifier).toHaveBeenCalledWith(entity);
