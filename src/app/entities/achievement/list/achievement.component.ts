...
import { AchievementService, EntityArrayResponseType } from '../service/achievement.service';
...
export class AchievementComponent implements OnInit {
  ...
  search(query: string): void {
    ...
    if (query && predicate && AchievementComponent.NOT_SORTABLE_FIELDS_AFTER_SEARCH.includes(predicate)) {
  ...
  protected fillComponentAttributeFromRoute(params: ParamMap, data: Data): void {
    ...
    if (params.has('search') && params.get('search') !== '') {
      ...
      const { predicate } = this.sortState();
      if (predicate && AchievementComponent.NOT_SORTABLE_FIELDS_AFTER_SEARCH.includes(predicate)) {
        this.sortState.set({});
      }
    }
  }
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.achievements.set(this.refineData(dataFromBody));
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: IAchievement[] | null): IAchievement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    if (this.currentSearch && this.currentSearch !== '') {
      return this.achievementService.search(queryObject).pipe(tap(() => (this.isLoading = false)));
    }
    return this.achievementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
