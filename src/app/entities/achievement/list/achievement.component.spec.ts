...
import { sampleWithRequiredData } from '../achievement.test-samples';
...
describe('Achievement Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.achievements()[0]).toEqual(expect.objectContaining({ id: 17559 }));
  });

  describe('trackId', () => {
    it('should forward to achievementService', () => {
      const entity = { id: 17559 };
      jest.spyOn(service, 'getAchievementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAchievementIdentifier).toHaveBeenCalledWith(entity);
